...
class TemporalAttentionLayer(torch.nn.Module):
    ...
    def __init__(
            self, n_node_features, n_neighbors_features, n_edge_features,
    ...
    def forward(self, src_node_features, src_time_features, neighbors_features,
        ...
        query = torch.cat(
            [src_node_features_unrolled, src_time_features],
            dim=2)
        key = torch.cat([neighbors_features, edge_features,
                        neighbors_time_features], dim=2)
        ...
        # [n_neighbors, batch_size, num_of_features]
